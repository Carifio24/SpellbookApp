...
class GlobalInfo {
    ...
    static final Version VERSION = new Version(4,0,5);
    ...
    static final Version UPDATE_LOG_VERSION = new Version(4,0,0);
    static final String UPDATE_LOG_CODE = UPDATE_LOG_VERSION.string();
    static final int UPDATE_LOG_TITLE_ID = R.string.update_04_00_00_title;
    static final int UPDATE_LOG_DESCRIPTION_ID = R.string.update_04_00_00_description;
