...
class GlobalInfo {
    ...
    static final Version VERSION = new Version(3,3,0);
    ...
    static final Version UPDATE_LOG_VERSION = new Version(3,3,0);
    static final String UPDATE_LOG_CODE = UPDATE_LOG_VERSION.string();
    static final int UPDATE_LOG_TITLE_ID = R.string.update_03_03_00_title;
    static final int UPDATE_LOG_DESCRIPTION_ID = R.string.update_03_03_00_description;
