...
class LegacyUtilities {
    ...
    static CharacterProfile profileFromJSONOld(JSONObject json) throws JSONException {
        ...
        final EnumSet<CasterClass> visibleClasses = (filterClass != null) ? EnumSet.of(filterClass) : EnumSet.allOf(CasterClass.class);
